...
<style>
	...
	/* The claim/value columns fight below phone-landscape — the claim
	   compresses to a sliver and the mono value clips. Stack them. */
	...
	.foot {
		...
		margin-top: 10px;
		font-family: var(--mono);
		/* The detail is prose, not a data chip — it reads at body scale with
		   near-zero tracking. The attribution label below stays small: it is
		   a label. */

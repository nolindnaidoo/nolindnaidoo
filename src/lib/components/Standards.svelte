...
import { standards, standardsNote } from '$content/standards';
import Band from './Band.svelte';
import Note from './Note.svelte';
</script>

<Note text={standardsNote} />
...
<Band>
	...
	<!-- The stack sits under the gates on purpose: what it is built with is the
	     answer to a question the gates raise, not a claim standing on its own. -->
	<ul class="stack">
